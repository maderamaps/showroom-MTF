...
mix.js("resources/js/user/notification.js", "public/js")
...
mix.js("resources/js/user/userProfile.js", "public/js")
    .vue()
    .sass('resources/sass/adminApproveRegistrasi.scss', 'public/css')
    .sass('resources/sass/adminListShowroom.scss', 'public/css')
    .sass('resources/sass/adminApproveTransaksi.scss', 'public/css')
    .sass('resources/sass/adminApproveReward.scss', 'public/css')
    .sass('resources/sass/adminApproveWithdraw.scss', 'public/css')
