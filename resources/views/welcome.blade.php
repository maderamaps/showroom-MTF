...
<head>
    ...
    <!--====== Title ======-->
    <title>MTF Showroom Alchemist</title>
                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            <!-- <a class="navbar-brand" href="index.html">
                                <img src="assets/images/logo_mtf.png" alt="Logo">
                            </a> -->
                            ...
                            <div class="navbar-btn d-none d-sm-inline-block">
                                <a class="main-btn" data-scroll-nav="0" href="{{ route('Dashboard') }}">Sign Up</a>
                            </div>
                        </nav> <!-- navbar -->
                    </div>
                </div> <!-- row -->
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="header-hero-content text-center">
                            <h3 class="header-sub-title wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.2s">Mandiri Tunas Finance</h3>
                            <h2 class="header-title wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.5s">Showroom Alchemist</h2>
                            <p class="text wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.8s">ayo daftar sekarang dan dapatkan reward</p>
                            <a href="{{ route('Dashboard') }}" class="main-btn wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="1.1s">Mulai Sekarang</a>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="section-title text-center pb-40">
                        ...
                        <h3 class="title">Mulai beralih ke MTF, <span> dapatkan kejutan menarik!</span></h3>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            <div class="row justify-content-center">
